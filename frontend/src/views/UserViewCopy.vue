...
async function getWoche() {
  ...
  await getPlanByWoche(woche.value, true)
  await goToToday(new Date().toDateString())
...
async function goToToday(date: string) {
...
<template>
  <div class="d-flex-column align-items-start">
    <div id="title" class="sticky-top p-3" style="background-color: white">
      <div class="py-2"></div>
      <h1 class="txt-moos pt-3">Kila Mooswuffel</h1>
      <h6 class="txt-moos pb-2">
        ...
        <a
          ...
          v-bind:style="
            isAktuell
              ...
              : 'background-color: white; border: 1px solid forestgreen; color: forestgreen;'
          "
          >Aktuelle Woche</a
        >
        <a
    ...
    <div>
      <div class="d-flex flex-wrap justify-content-start">
        ...
        <div
          ...
          class="d-flex flex-grow-1 flex-sm-grow-0 flex-md-grow-0 align-items-baseline"
